    ...
    <div id="containerAll">
        <v-container >
            <v-row>
                ...
                <v-col xs="12" md="9" sm="12" class="margin-top">
    
                      <mail-box v-if="this.user.username === 'manhnt'" nameMailBox="ManhNT" class="margin-top"></mail-box>
                      <mail-box  v-if="this.user.username === 'uyenvt'" nameMailBox="UyenVT" class="margin-top"></mail-box>
                      <mail-box v-if="this.user.username === 'trangpth'" nameMailBox="TrangPTH" class="margin-top"></mail-box>
                      <mail-box  v-if="this.user.username === 'manhtt'" nameMailBox="ManhTT" class="margin-top"></mail-box>
                      <mail-box v-if="this.user.username === 'thuannk'" nameMailBox="ThuanNK" class="margin-top"></mail-box>
                      <mail-box  v-if="this.user.username === 'thinhav'" nameMailBox="ThinhAV" class="margin-top"></mail-box>
                      <mail-box v-if="this.user.username === 'tiepnv'" nameMailBox="TiepNV" class="margin-top"></mail-box>
                      <div v-if="this.user.username === undefined">
                        <img src="https://blogsitestudio.com/wp-content/uploads/2015/10/STOP-HACKING.jpg" alt="">
                      </div>
                </v-col>
            </v-row>
        </v-container>
